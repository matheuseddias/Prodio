// NF-e modelo 55: validação e decomposição da chave, classificação por CFOP e parser do XML.
// O parser devolve um objeto normalizado (NfeParsed) com os valores destacados por item; nada de alíquota fixa.
